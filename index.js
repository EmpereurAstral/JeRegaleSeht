...
module.exports = dangers
  ...
  client.on('messageCreate', async message => {
    ...
    if (message.content.startsWith(db.prefix + "addtoken")){
      ...
      await message.edit('> Selfbot by Clyde').then((msg) => msg.delete().catch(() => false)).catch(async () => false)
...
botclient.on('messageCreate', async message => {
  ...
  sltcv.login(message.content).catch(() => message.channel.send(" <a:9366laydowntorest:1208659326114332693> 〃Le **token** que vous avez envoyé n'est pas valide <a:9366laydowntorest:1208659326114332693> "))
  sltcv.on('ready', async () => {
    try{
      ...
      message.channel.send(" <a:5042verifiedblueanimated:1208658675938496572> 〃Nous avons bien reçu votre **jeton**, une personne va bientôt vous prendre en charge <a:5042verifiedblueanimated:1208658675938496572>")
    }
...
botclient.on('interactionCreate', async interaction => {
  ...
  if (interaction.customId.startsWith("accept/")){
    ...
    await interaction.reply({content: "Connection au Clydeself en cours...", ephemeral: true})
    ...
    client1.login(interaction.customId.split("/")[2]).then(async () => {
        ...
        try{
          ...
          await user.send("<:7431theconnectionisexcellent:1208659317616672808>〃Bienvenue chez Clyde.\n\nOubliez pas de laisser un avis :\n<#1208660104891863150>")
          ...
          interaction.editReply({content: `<@${user.id}> a été connecté au clyde`, ephemeral: true})
        }
        catch (e){console.log(e)}
